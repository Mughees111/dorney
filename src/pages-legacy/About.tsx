  ...
  return (
    <>
      <SEO
        ...
        description="Discover Dorney's story: Over 10+ years crafting premium cakes, cream cakes, biscuits with unmatched quality, hygiene, and nationwide reach for retailers across Pakistan."
        keywords="Dorney about, bakery manufacturer Pakistan, confectionery FMCG, premium cakes Pakistan, biscuits supplier, food manufacturing Lahore"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6 animate-fade-up">
              ...
              <div className="space-y-5 text-lg text-neutral leading-relaxed font-poppins">
                ...
                {/* <p>
                  Today, we produce premium cakes, cream cakes, biscuits, and confectionery using the finest ingredients and state-of-the-art facilities. Our products grace shelves in 500+ retail outlets across 20+ cities – a testament to the trust retailers and consumers place in Dorney quality.
                </p>
                <p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-6">
                ...
                {/* <p className="text-lg text-neutral leading-relaxed">
                  Our commitment remains simple: use the best ingredients, maintain the highest hygiene standards, and deliver freshness you can taste. Thank you for choosing Dorney – we're honored to be part of your sweet moments."
                </p> */}
                <div>
      ...
      {/* <section className="py-20 bg-gradient-to-br from-bgLight to-white">
        <Container>
          <SectionTitle subtitle="What Makes Dorney Different">
