  ...
  return (
    <section className="py-20 md:py-28 bg-gradient-cta relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30 pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-gold/5 via-transparent to-primary/5"></div>
        <div className="absolute top-20 left-1/4 w-96 h-96 bg-white/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 right-1/4 w-96 h-96 bg-gold/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <Container className="relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <Button
            ...
            variant="outline"
            size="xl"
            className="bg-white/10 backdrop-blur-sm border-2 border-gold text-white hover:bg-gold hover:text-charcoal transition-all duration-300 px-10 py-6 text-lg md:text-xl font-semibold uppercase tracking-wide group shadow-lg"
          >
