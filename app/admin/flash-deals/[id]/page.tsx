...
export default function EditFlashDealPage() {
  ...
  useEffect(() => {
    fetch(`/api/flash-deals/${id}`, { credentials: "include" })
      .then((r) => r.json())
      .then((data) => {
        if (data && data.id) {
          setForm({
  ...
  return (
    <div className="max-w-3xl">
      <h1 className="text-2xl font-bold text-gray-900 mb-2">Edit Flash Deal</h1>
      <p className="text-gray-500 mb-8">Update the flash deal details.</p>
