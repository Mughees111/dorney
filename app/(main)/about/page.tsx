        ...
        <Container>
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-dark font-poppins font-medium max-w-4xl mx-auto">
              Pakistan&apos;s premier FMCG bakery manufacturer – where tradition
              meets modern excellence in every bite.
            </p>
          </div>
        </Container>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-5 text-lg text-neutral leading-relaxed font-poppins">
                <p>
                  M.K.S Foods International Pvt Limited&apos;s layer cakes are
                  available in a variety of flavours, including vanilla,
                  chocolate, and coffee. These cakes are made with multiple
                  layers of soft, moist cake and delicious cream, making them a
                  favourite among cake lovers. Their donuts are also available in
                  various flavours, such as glazed, chocolate, and strawberry.
                  They are made with a light and fluffy dough that is fried to
                  perfection, giving them a crisp exterior and a soft, fluffy
                  interior.
                </p>
              </div>
            </div>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
            <div className="bg-white p-10 rounded-2xl shadow-xl border border-neutral/20 hover:shadow-2xl transition-all duration-300">
              ...
              <h3 className="text-3xl font-cookie text-primary text-center mb-4">
                Our Mission
              </h3>
              <p className="text-lg text-neutral leading-relaxed text-center">
                Our AIM is to provide you good hygienic and quality based
                products. Our Product Quality ensures our vision and your trust
                on us We truly believe in customer satisfaction so your trust is
                our power.
              </p>
            </div>
            ...
            <div className="bg-white p-10 rounded-2xl shadow-xl border border-neutral/20 hover:shadow-2xl transition-all duration-300">
              ...
              <p className="text-lg text-neutral leading-relaxed text-center">
                To become the most trusted and beloved bakery brand across
                Pakistan, recognized for our unwavering commitment to quality,
                hygiene, and innovation in every bite.
              </p>
            </div>
          </div>
        </Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-6">
              <div className="flex items-center gap-5 mb-6">
                ...
                <h2 className="text-4xl font-cookie text-dark">
                  Nationwide Reach
                </h2>
              </div>
              <div className="text-lg text-neutral leading-relaxed font-poppins space-y-4">
                <p>
                  <span className="font-bold">Quality Products Across Pakistan</span>
                  <br />
                  We want everyone in Pakistan to enjoy our delicious cakes and
                  donuts. That&apos;s why we deliver our products to cities and
                  towns all across the country. Our strong delivery network makes
                  sure our products stay fresh when they reach you.
                </p>
                <p>
                  You can find our layer cakes and donuts at major supermarkets,
                  grocery stores, and shops nationwide.
                </p>
                <p>M.K.S Foods - Fresh taste, everywhere in Pakistan.</p>
              </div>
            </div>
          </div>
        </Container>
